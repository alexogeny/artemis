"""Generate OpenAPI specifications from Artemis route metadata."""
...
def generate_openapi(app: ArtemisApp, *, title: str | None = None, version: str = "1.0.0") -> dict[str, Any]:
