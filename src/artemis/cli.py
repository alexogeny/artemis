"""Command line utilities for Artemis."""
...
def _build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(prog="artemis", description="Artemis management commands")
...
def _load_environment(module_name: str) -> CLIEnvironment:
    ...
    if include_models:
        importlib.import_module("artemis.models")
